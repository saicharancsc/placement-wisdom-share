  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-purple-700 to-cyan-600">
        ...
        <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-white/5 rounded-full"></div>
      </div>
          ...
          <div className="text-center">
            <div className="animate-slide-in-up">
              <div className="flex items-center justify-center mb-6">
                ...
                <Sparkles className="w-6 h-6 text-yellow-300 ml-3" />
              </div>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              ...
              <br />
              <span className="bg-gradient-to-r from-cyan-200 via-yellow-200 to-pink-200 bg-clip-text text-transparent">
                Peer Experiences
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              {user ? (
                <Link to="/create">
                  <Button size="lg" className="bg-white/20 backdrop-blur-sm border-2 border-white/30 text-white hover:bg-white hover:text-blue-600 font-semibold px-8 py-4 text-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 group">
              ...
              <Button 
                ...
                className="bg-transparent border-2 border-white/50 text-white hover:bg-white/10 backdrop-blur-sm font-semibold px-8 py-4 text-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                Browse Experiences
              </Button>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="space-y-2 group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:shadow-xl transition-all duration-300">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index} 
                className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/50 hover:shadow-2xl transition-all duration-300 group"
              >
                <div className={`w-12 h-12 bg-gradient-to-br ${feature.gradient} rounded-xl flex items-center justify-center mb-4 text-2xl transition-transform duration-300`}>
                  {feature.icon}
                </div>
